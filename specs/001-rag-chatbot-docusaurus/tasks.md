...
- [ ] T001 Create project structure with backend/ and docusaurus/ directories
- [ ] T002 Initialize Python project with FastAPI dependencies in backend/
- [ ] T003 Initialize Node.js project with Docusaurus dependencies in docusaurus/
- [ ] T004 [P] Create requirements.txt with FastAPI, Cohere SDK, Qdrant client, Neon Postgres driver
- [ ] T005 [P] Create .env.example with COHERE_API_KEY, QDRANT_CLUSTER_ID, QDRANT_ENDPOINT, QDRANT_API_KEY, NEON_DB_URL
- [ ] T006 Create initial directory structure for backend/src/models/, backend/src/services/, backend/src/api/, backend/src/utils/
- [ ] T007 Create initial directory structure for docusaurus/src/components/Chatbot/
...
- [ ] T008 Setup database connection and models in backend/src/models/
- [ ] T009 [P] Implement Qdrant vector store connection in backend/src/services/qdrant_service.py
- [ ] T010 [P] Implement Neon database connection in backend/src/services/neon_service.py
- [ ] T011 Create base models for Query, Retrieved Context, Generated Response, and Chat Session in backend/src/models/
- [ ] T012 Setup FastAPI app structure with routing in backend/src/api/main.py
- [ ] T013 [P] Configure CORS middleware for frontend-backend communication
- [ ] T014 Setup environment variable loading in backend/src/config.py
- [ ] T015 [P] Create base API endpoints structure in backend/src/api/routes/
- [ ] T016 Setup Cohere API integration in backend/src/services/cohere_service.py
- [ ] T017 Implement text splitting utilities in backend/src/utils/text_splitter.py
- [ ] T018 Implement embedding generation utilities in backend/src/utils/embeddings.py
- [ ] T019 Create ingestion pipeline structure in backend/ingestion/main.py
- [ ] T020 Create basic chatbot component structure in docusaurus/src/components/Chatbot/Chatbot.tsx
...
- [ ] T021 [P] [US1] Contract test for POST /query endpoint in backend/tests/contract/test_query.py
- [ ] T022 [P] [US1] Integration test for basic query functionality in backend/tests/integration/test_query_flow.py
- [ ] T023 [P] [US1] Unit test for Cohere response generation in backend/tests/unit/test_cohere_service.py

### Implementation for User Story 1

- [ ] T024 [P] [US1] Create Query model in backend/src/models/query.py
- [ ] T025 [P] [US1] Create RetrievedContext model in backend/src/models/retrieved_context.py
- [ ] T026 [P] [US1] Create GeneratedResponse model in backend/src/models/response.py
- [ ] T027 [P] [US1] Create ChatSession model in backend/src/models/chat_session.py
- [ ] T028 [US1] Implement RAG service in backend/src/services/rag_service.py
- [ ] T029 [US1] Implement citation service in backend/src/services/citation_service.py
- [ ] T030 [US1] Implement POST /query endpoint in backend/src/api/routes/query.py
- [ ] T031 [US1] Add response validation and error handling in backend/src/api/routes/query.py
- [ ] T032 [US1] Create chat window UI component in docusaurus/src/components/Chatbot/ChatWindow.tsx
- [ ] T033 [US1] Create query input component in docusaurus/src/components/Chatbot/QueryInput.tsx
- [ ] T034 [US1] Implement chatbot communication with backend API in docusaurus/src/components/Chatbot/Chatbot.tsx
- [ ] T035 [US1] Add citation display in chat responses in docusaurus/src/components/Chatbot/ChatWindow.tsx
- [ ] T036 [US1] Implement mobile responsive design for chat interface in docusaurus/src/components/Chatbot/
...
- [ ] T037 [P] [US2] Contract test for POST /query-selected endpoint in backend/tests/contract/test_query_selected.py
- [ ] T038 [P] [US2] Integration test for selected text query functionality in backend/tests/integration/test_selected_query_flow.py

### Implementation for User Story 2

- [ ] T039 [US2] Implement POST /query-selected endpoint in backend/src/api/routes/query_selected.py
- [ ] T040 [US2] Enhance RAG service to handle selected text context in backend/src/services/rag_service.py
- [ ] T041 [US2] Create text selection utility in docusaurus/src/utils/textSelection.ts
- [ ] T042 [US2] Implement floating action button for "Ask about selected text" in docusaurus/src/components/Chatbot/Chatbot.tsx
- [ ] T043 [US2] Add selected text highlighting and context handling in docusaurus/src/components/Chatbot/
- [ ] T044 [US2] Modify backend API client to handle selected text queries in docusaurus/src/components/Chatbot/Chatbot.tsx
...
**Goal**: Implement the content ingestion pipeline to process textbook content into Qdrant vector store and Neon database
